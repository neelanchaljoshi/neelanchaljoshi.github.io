...
I am a doctoral researcher at the Max Planck Institute for Solar System Research in Göttingen, Germany, where I study large-scale flows inside the Sun using a technique called Local Correlation Tracking. My work sits at the intersection of observational solar physics, signal processing, and big data — I spend a lot of time building pipelines to extract weak physical signals from terabytes of solar imagery, and finding new ways to push the limits of what space instruments can measure. Part of my doctoral work has also involved preparing for the ESA Vigil mission, a future space weather monitoring satellite, by characterising how well its instruments will be able to detect solar surface flows.
...
If you want to get in touch, you can reach me on the links below.
